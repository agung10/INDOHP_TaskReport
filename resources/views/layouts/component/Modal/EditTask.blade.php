                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="IStartedAt" type="text" class="form-control" data-toggle="input-mask" data-mask-format="0000/00/00 00:00:00" name="started_at" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="IEndedAt" type="text" class="form-control" data-toggle="input-mask" data-mask-format="0000/00/00 00:00:00" name="ended_at" required>
                            <span class="font-13 text-muted">e.g "YYYY/MM/DD HH:MM:SS"</span>
                        </div>
                    </div>
                </div>
